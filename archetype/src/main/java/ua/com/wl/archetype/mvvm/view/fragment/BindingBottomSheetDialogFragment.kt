...
abstract class BindingBottomSheetDialogFragment<B : ViewDataBinding, VM : FragmentViewModel> : BaseFragment() {
    ...
    protected abstract fun onBind(binding: B, savedInstanceState: Bundle?): VM
